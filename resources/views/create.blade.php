    ...
    <section class="text-gray-600 body-font relative -mt-4">
        <div class="container px-5 py-12 mx-auto">
          <div class="flex flex-col text-center w-full mb-12">
            ...
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Please get in touch</p>
          </div>
          ...
          <div class="lg:w-1/2 md:w-2/3 mx-auto">
            <div class="flex flex-wrap -m-2">
              ...
              <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                <a class="text-indigo-500" href=" https://veilmail.io/irish-geoff">If you don't like forms click to reveal email address https://veilmail.io/irish-geoff</a>
